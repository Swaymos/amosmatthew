      ...
      <main className="  max-w-screen ">
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className="feature-list">
            ...
            <p>
              👉 <strong>Edit Post Functionality</strong>: Provide users with
              the ability to edit the content of their posts at any time
            </p>
            <p>
            ...
            <p>
              ...
              enhance performance, Parallel queries for efficient data
              retrieval, First-class Mutations, etc
            </p>
            <p>
              👉 <strong>Backend as a Service (BaaS) - Appwrite</strong>:
              Utilize Appwrite as a Backend as a Service solution for
              streamlined backend development, offering features like
              authentication, database, file storage, and more
            </p>
          </div>
