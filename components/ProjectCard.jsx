          ...
          >
            ...
            >
              <Image
                ...
                alt={project.title}
                width="100%"
                className="transition rounded-md max-w-[80%] drop-shadow-2xl hover:scale-110"
              />
              <div className="text-left">
                <h1 className="font-semibold text-[1.5rem] mt-5 text-gray-700 dark:text-white">
                  {project.title}
                </h1>
                <p className="py-2 max-w-[80%] text-gray-400 font-light">
                  {project.description}
                </p>
              </div>
            </Link>
            ...
            <div className="text-left w-full pt-2">
              <Link
                href={project.link}
                target="_blank"
                className="font-normal lg:font-bold space-x-2 text-sm md:text-base hover:text-fuchsia-700"
              >
                <p>View Project</p>
              </Link>
            </div>
